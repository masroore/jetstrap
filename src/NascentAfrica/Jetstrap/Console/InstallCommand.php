...
class InstallCommand extends Command
{
    ...
    public function handle()
    {
        ...
        // Install Stack...
        if ('livewire' === $this->argument('stack')) {
            $this->swapJetstreamLivewireStack();
        } elseif ('inertia' === $this->argument('stack')) {
            $this->swapJetstreamInertiaStack();
        } elseif ('breeze' === $this->argument('stack')) {
            $this->swapBreezeStack();
        } elseif ('breeze-inertia' === $this->argument('stack')) {
